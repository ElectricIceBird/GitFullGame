...
public class TaskGrab : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (grabcheck.collider.CompareTag("Donut")|| grabcheck.collider.CompareTag("Coffee"))
            {
               
                return;
            }
            else{ 
            if (Input.GetKey(KeyCode.G) && grabcheck.collider.CompareTag("Task"))
            {
